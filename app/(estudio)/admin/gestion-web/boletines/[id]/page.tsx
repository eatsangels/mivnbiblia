...
import { getBulletinById } from "@/lib/queries/bulletins";
...
export default async function EditBulletinPage({ params }: EditBulletinPageProps) {
    ...
    const updateBulletinWithId = updateBulletin.bind(null, id);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-800 p-8">
                <form action={updateBulletinWithId} className="space-y-6">
                    {/* Title */}
                    <div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="publish_date"
                            required
                            defaultValue={bulletin.publish_date}
                            className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:border-mivn-blue focus:ring-2 focus:ring-mivn-blue/20 outline-none transition-all"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <input
                            ...
                            id="is_published"
                            name="is_published"
                            defaultChecked={bulletin.is_published}
