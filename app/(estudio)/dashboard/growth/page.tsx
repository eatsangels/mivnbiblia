...
import { Home, Bell, LayoutDashboard, TrendingUp, Users, User, Heart } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFB] dark:bg-[#05070a] transition-colors duration-500 font-lexend">
            ...
            <header className="sticky top-0 z-50 bg-white/80 dark:bg-[#05070a]/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 h-20">
                <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex items-center gap-10">
                        ...
                        <Link href="/dashboard/growth" className="text-[10px] font-black uppercase tracking-widest text-mivn-blue border-b-2 border-mivn-blue pb-1">Mi Crecimiento</Link>
                        ...
                        <Link href="/dashboard/donations" className="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-mivn-blue transition-colors">Donaciones</Link>
                    </nav>
            ...
            <main className="max-w-7xl mx-auto px-6 py-16 w-full">
                <SpiritualGrowth profile={profile} />
            </main>
