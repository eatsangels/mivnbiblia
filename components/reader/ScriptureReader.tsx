...
import { Play, MessageCircle, PenTool, Highlighter, Sparkles, MessageSquarePlus, ChevronRight, BookOpen, Layers, Volume2, Type } from 'lucide-react';
        ...
        <div className="w-full h-full flex flex-col relative font-sans">
            ...
            <div className="flex items-center justify-between mb-6 px-2">
                ...
                <div className="flex gap-2 text-gray-400">
                    {/* Placeholder search icon from image */}
                </div>
            </div>
                                    ...
                                    <div className="p-6 md:p-8">
                                        ...
                                        <div className="bg-[#f2f4f8] rounded-xl p-5 border border-gray-200/50">
                                            ...
                                            {activeTab === 'community' ? (
                                                ...
                                                <div className="text-sm text-gray-600 leading-relaxed font-sans mt-2">
                                                    {/* Simulated Content matching the image aesthetic */}
                                                    <div className="flex justify-between items-end">
                                                        <div className="flex-1">
                                                            <p className="mb-2">
                                                                <span className="font-bold text-[#1a2b4b]">• {verse.book_name} {verse.chapter}:{verse.verse_number}</span> usa
                                                                <span className="text-blue-600 font-medium"> ideo enratu sueteris </span>
                                                                su Dios al mundo, quanetio (a dioss). El comentario de hace dios convierte para perrius...
                                                            </p>
                                                            <p className="text-xs text-gray-400">
                                                                Dél consintario, des procento de ciato maco...
                                                            </p>
                                                        </div>
                                                        <span className="text-[10px] text-gray-400 font-mono ml-4">173</span>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
